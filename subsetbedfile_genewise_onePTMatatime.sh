...
input_file="/home/asmita/my_dir1/nucpos_200/Modified_human_protein_coding_genes_GRCh37.csv"	##complete path to the human gene csv file
input_bed="/home/asmita/my_dir1/nucpos_200/h3k36me3heartRV34yr.bed"	##complete path to PTM bed file

## Output directory
output_dir="h3k36me3heartRV34yr_subset_bed_files"
mkdir -p "$output_dir"
