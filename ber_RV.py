...
# File paths
file1 = '3yr_final_RV.csv'
file2 = '34yr_final_RV.csv'
...
# NEW: Filter genes where all modifications have BER < 0.05
...
if genes_filtered.empty:
    ...
    output_file = 'ber_all_mods_less_than_5percent_RV_3vs34.csv'
